...
pcs -f clust_cfg resource create mysql_service01 ocf:heartbeat:mysql binary="/usr/bin/mysqld_safe" config="/etc/my.cnf" datadir="/var/www/html/mysql" pid="/var/www/html/mysql/mysql.pid" socket="/var/www/html/mysql/mysql.sock" additional_parameters="--bind-address=0.0.0.0" op start timeout=60s op stop timeout=60s \ op monitor interval=20s timeout=30s
